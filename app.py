...
if tool_selection == "Research Advisor":
    ...
    st.write("Optimized For ChatGPT (GPT-4)")
      ...
      def copy_text_to_clipboard(text):
          ...
          <button onclick="copyTextToClipboard()" style="background-color: #152238; color: white; border-radius: 5px; padding: 0.5em 1em; font-size: 1em;">Copy Generated Prompt to Clipboard</button>
          <script>
